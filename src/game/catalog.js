...
export const SKINS = [
  skin("standard", "Field Issue", "#404a43", "#202923", 0, "STANDARD"),
  skin("desert", "Desert Sand", "#b49a70", "#56462d", 250),
  skin("arctic", "Arctic Wolf", "#e5eaf0", "#668493", 350),
  skin("crimson", "Crimson Strike", "#a81d31", "#f1b485", 500),
  skin("gold", "Royal Gold", "#e8bc53", "#211d27", 900, "LEGENDARY"),
  skin("toxic", "Toxic Venom", "#94c83d", "#1f3223", 650),
  skin(
    "glacier",
    "Glacier Reborn",
    "#b8edff",
  ...
  skin("nebula", "Nebula Shift", "#7548b7", "#6adcf4", 1400, "MYTHIC", "cyber"),
  skin(
    "cyber",
    "Cyber Circuit",
    "#173e4d",
  ...
  skin("obsidian", "Obsidian Edge", "#262035", "#be88ff", 1000),
  skin("tiger", "Tiger Strike", "#cf8632", "#262328", 500),
  skin("ocean", "Ocean Depth", "#236c8d", "#a2edf1", 600),
  skin("royal", "Royal Guard", "#3431a4", "#e9c26a", 850),
  skin("spectrum", "Spectrum Fade", "#e755aa", "#79d9ec", 950),
];
export const KNIVES = [
